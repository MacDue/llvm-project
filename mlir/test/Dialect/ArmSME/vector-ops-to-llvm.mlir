// RUN: mlir-opt %s --pass-pipeline="builtin.module(func.func(convert-vector-to-arm-sme,convert-arith-to-arm-sme,convert-arm-sme-to-llvm,cse,canonicalize))" \
// RUN: -split-input-file -allow-unregistered-dialect -verify-diagnostics | FileCheck %s
