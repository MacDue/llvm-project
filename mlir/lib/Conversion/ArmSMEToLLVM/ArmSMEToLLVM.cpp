//===- ArmSMEToLLVM.cpp - Convert ArmSME to SCF dialect ----------*- C++
//-*-===//
//
...
struct ConvertArmSMEToLLVMPass
  ...
  void runOnOperation() override {
    ...
    patterns
        .add<LoadTileSliceConversion, StoreTileSliceConversion,
             MoveVectorToTileSliceConversion, MoveTileSliceToVectorConversion,
             OuterProductOpConversion, GetTileConversion, ZeroOpConversion>(
            converter);
