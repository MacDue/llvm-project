...
; CHECK-NEXT:    t21: nxv2i64,ch = LDR_ZXI<Mem:(volatile load (<vscale x 2 x i64>) from %ir.a, align 64)> t2, TargetConstant:i64<0>, t0
...
; CHECK-NEXT:    t22: ch = STR_ZXI<Mem:(volatile store (<vscale x 2 x i64>) into %ir.r0, align 64)> t21, t6, TargetConstant:i64<0>, t21:1
; CHECK-NEXT:    t23: ch = STR_ZXI<Mem:(volatile store (<vscale x 2 x i64>) into %ir.r1, align 64)> t21, t8, TargetConstant:i64<0>, t22
