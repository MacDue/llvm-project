...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x08, 0x6f, 0x90, 0x2e, 0x38, 0x1e, 0x22, 0x40, 0x22 // sp + 8 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #1
...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x10, 0x20, 0x1e, 0x22, 0x40, 0x22 // sp + 32 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #4
; CHECK-NEXT:    .cfi_def_cfa wsp, 16
; CHECK-NEXT:    ldr x29, [sp], #16 // 8-byte Folded Reload
; CHECK-NEXT:    .cfi_def_cfa_offset 0
...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x80, 0x01, 0x1e, 0x22, 0x40, 0x22 // sp + 128 * VG + 16
...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x59, 0x90, 0x2e, 0x10, 0x88, 0x01, 0x1e, 0x22, 0x40, 0x22 // $x9 + 136 * VG + 16
...
; CHECK-NEXT:    .cfi_escape 0x10, 0x48, 0x08, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x40, 0x1c // $d8 @ cfa - 8 * VG - 16
; CHECK-NEXT:    //APP
; CHECK-NEXT:    //NO_APP
...
; CHECK-NEXT:    .cfi_escape 0x10, 0x48, 0x08, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x40, 0x1c // $d8 @ cfa - 8 * VG - 16
; CHECK-NEXT:    .cfi_escape 0x10, 0x49, 0x08, 0x90, 0x2e, 0x11, 0x70, 0x1e, 0x22, 0x40, 0x1c // $d9 @ cfa - 16 * VG - 16
; CHECK-NEXT:    .cfi_escape 0x10, 0x4a, 0x08, 0x90, 0x2e, 0x11, 0x68, 0x1e, 0x22, 0x40, 0x1c // $d10 @ cfa - 24 * VG - 16
; CHECK-NEXT:    .cfi_escape 0x10, 0x4b, 0x08, 0x90, 0x2e, 0x11, 0x60, 0x1e, 0x22, 0x40, 0x1c // $d11 @ cfa - 32 * VG - 16
; CHECK-NEXT:    //APP
; CHECK-NEXT:    //NO_APP
...
; CHECK-NEXT:    .cfi_escape 0x10, 0x4a, 0x08, 0x90, 0x2e, 0x11, 0x68, 0x1e, 0x22, 0x40, 0x1c // $d10 @ cfa - 24 * VG - 16
; CHECK-NEXT:    .cfi_escape 0x10, 0x4b, 0x08, 0x90, 0x2e, 0x11, 0x60, 0x1e, 0x22, 0x40, 0x1c // $d11 @ cfa - 32 * VG - 16
; CHECK-NEXT:    .cfi_escape 0x10, 0x4c, 0x08, 0x90, 0x2e, 0x11, 0x58, 0x1e, 0x22, 0x40, 0x1c // $d12 @ cfa - 40 * VG - 16
; CHECK-NEXT:    .cfi_escape 0x10, 0x4d, 0x08, 0x90, 0x2e, 0x11, 0x50, 0x1e, 0x22, 0x40, 0x1c // $d13 @ cfa - 48 * VG - 16
; CHECK-NEXT:    .cfi_escape 0x10, 0x4e, 0x08, 0x90, 0x2e, 0x11, 0x48, 0x1e, 0x22, 0x40, 0x1c // $d14 @ cfa - 56 * VG - 16
; CHECK-NEXT:    .cfi_escape 0x10, 0x4f, 0x08, 0x90, 0x2e, 0x11, 0x40, 0x1e, 0x22, 0x40, 0x1c // $d15 @ cfa - 64 * VG - 16
; CHECK-NEXT:    //APP
; CHECK-NEXT:    //NO_APP
...
; CHECK-NEXT:    addvl sp, sp, #-1
; CHECK-NEXT:    .cfi_escape 0x0f, 0x08, 0x6f, 0x90, 0x2e, 0x38, 0x1e, 0x22, 0x23, 0x20 // sp + 8 * VG + 32
; CHECK-NEXT:    addvl sp, sp, #1
...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0b, 0x59, 0x90, 0x2e, 0x10, 0x80, 0x02, 0x1e, 0x22, 0x23, 0x90, 0x60 // $x9 + 256 * VG + 12304
; CHECK-NEXT:    addvl x9, x9, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0b, 0x59, 0x90, 0x2e, 0x10, 0x80, 0x04, 0x1e, 0x22, 0x23, 0x90, 0x60 // $x9 + 512 * VG + 12304
...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0b, 0x6f, 0x90, 0x2e, 0x10, 0x88, 0x02, 0x1e, 0x22, 0x23, 0x90, 0x60 // sp + 264 * VG + 12304
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x40, 0x1e, 0x22, 0x23, 0x90, 0x60 // sp + 16 * VG + 12304
...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x80, 0x02, 0x1e, 0x22, 0x40, 0x22 // sp + 256 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x80, 0x04, 0x1e, 0x22, 0x40, 0x22 // sp + 512 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x80, 0x06, 0x1e, 0x22, 0x40, 0x22 // sp + 768 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x80, 0x08, 0x1e, 0x22, 0x40, 0x22 // sp + 1024 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x80, 0x0a, 0x1e, 0x22, 0x40, 0x22 // sp + 1280 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x80, 0x0c, 0x1e, 0x22, 0x40, 0x22 // sp + 1536 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x80, 0x0e, 0x1e, 0x22, 0x40, 0x22 // sp + 1792 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x80, 0x10, 0x1e, 0x22, 0x40, 0x22 // sp + 2048 * VG + 16
; CHECK-NEXT:    str xzr, [sp]
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x88, 0x0e, 0x1e, 0x22, 0x40, 0x22 // sp + 1800 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x90, 0x0c, 0x1e, 0x22, 0x40, 0x22 // sp + 1552 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x98, 0x0a, 0x1e, 0x22, 0x40, 0x22 // sp + 1304 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0xa0, 0x08, 0x1e, 0x22, 0x40, 0x22 // sp + 1056 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0xa8, 0x06, 0x1e, 0x22, 0x40, 0x22 // sp + 808 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0xb0, 0x04, 0x1e, 0x22, 0x40, 0x22 // sp + 560 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0xb8, 0x02, 0x1e, 0x22, 0x40, 0x22 // sp + 312 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x10, 0x40, 0x1e, 0x22, 0x40, 0x22 // sp + 64 * VG + 16
...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x59, 0x90, 0x2e, 0x10, 0x80, 0x02, 0x1e, 0x22, 0x40, 0x22 // $x9 + 256 * VG + 16
; CHECK-NEXT:    addvl x9, x9, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x59, 0x90, 0x2e, 0x10, 0x80, 0x04, 0x1e, 0x22, 0x40, 0x22 // $x9 + 512 * VG + 16
; CHECK-NEXT:    addvl x9, x9, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x59, 0x90, 0x2e, 0x10, 0x80, 0x06, 0x1e, 0x22, 0x40, 0x22 // $x9 + 768 * VG + 16
; CHECK-NEXT:    addvl x9, x9, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x59, 0x90, 0x2e, 0x10, 0x80, 0x08, 0x1e, 0x22, 0x40, 0x22 // $x9 + 1024 * VG + 16
; CHECK-NEXT:    addvl x9, x9, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x59, 0x90, 0x2e, 0x10, 0x80, 0x0a, 0x1e, 0x22, 0x40, 0x22 // $x9 + 1280 * VG + 16
; CHECK-NEXT:    addvl x9, x9, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x59, 0x90, 0x2e, 0x10, 0x80, 0x0c, 0x1e, 0x22, 0x40, 0x22 // $x9 + 1536 * VG + 16
; CHECK-NEXT:    addvl x9, x9, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x59, 0x90, 0x2e, 0x10, 0x80, 0x0e, 0x1e, 0x22, 0x40, 0x22 // $x9 + 1792 * VG + 16
; CHECK-NEXT:    addvl x9, x9, #-32
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x59, 0x90, 0x2e, 0x10, 0x80, 0x10, 0x1e, 0x22, 0x40, 0x22 // $x9 + 2048 * VG + 16
; CHECK-NEXT:    addvl x9, x9, #-1
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x59, 0x90, 0x2e, 0x10, 0x88, 0x10, 0x1e, 0x22, 0x40, 0x22 // $x9 + 2056 * VG + 16
...
; CHECK-NEXT:    .cfi_def_cfa_register wsp
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x90, 0x0e, 0x1e, 0x22, 0x40, 0x22 // sp + 1808 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x98, 0x0c, 0x1e, 0x22, 0x40, 0x22 // sp + 1560 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0xa0, 0x0a, 0x1e, 0x22, 0x40, 0x22 // sp + 1312 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0xa8, 0x08, 0x1e, 0x22, 0x40, 0x22 // sp + 1064 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0xb0, 0x06, 0x1e, 0x22, 0x40, 0x22 // sp + 816 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0xb8, 0x04, 0x1e, 0x22, 0x40, 0x22 // sp + 568 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0xc0, 0x02, 0x1e, 0x22, 0x40, 0x22 // sp + 320 * VG + 16
; CHECK-NEXT:    addvl sp, sp, #31
; CHECK-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x10, 0x48, 0x1e, 0x22, 0x40, 0x22 // sp + 72 * VG + 16
...
; CHECK-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x10, 0x28, 0x1e, 0x22, 0x40, 0x22 // sp + 40 * VG + 16
; CHECK-NEXT:    str xzr, [sp]
; CHECK-NEXT:    addvl sp, sp, #5
; CHECK-NEXT:    .cfi_def_cfa wsp, 16
; CHECK-NEXT:    ldr x29, [sp], #16 // 8-byte Folded Reload
