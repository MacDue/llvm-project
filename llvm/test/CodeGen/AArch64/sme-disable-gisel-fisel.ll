...
define double  @za_shared_caller_to_za_none_callee(double %x) nounwind noinline "aarch64_inout_za"{
...
; CHECK-COMMON-NEXT:    rdsvl x8, #1
; CHECK-COMMON-NEXT:    mov x10, #15 // =0xf
; CHECK-COMMON-NEXT:    mov x9, sp
; CHECK-COMMON-NEXT:    madd x10, x8, x8, x10
; CHECK-COMMON-NEXT:    and x10, x10, #0xfffffffffffffff0
; CHECK-COMMON-NEXT:    sub x9, x9, x10
...
; CHECK-COMMON-NEXT:    fadd d0, d0, d1
; CHECK-COMMON-NEXT:    smstart za
; CHECK-COMMON-NEXT:    cbnz x8, .LBB7_2
; CHECK-COMMON-NEXT:  // %bb.1: // %restore.za
; CHECK-COMMON-NEXT:    sub x0, x29, #16
; CHECK-COMMON-NEXT:    bl __arm_tpidr2_restore
; CHECK-COMMON-NEXT:  .LBB7_2: // %after.restore.za
; CHECK-COMMON-NEXT:    msr TPIDR2_EL0, xzr
