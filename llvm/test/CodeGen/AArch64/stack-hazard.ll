...
; CHECK0-NEXT:    .cfi_escape 0x0f, 0x08, 0x6f, 0x90, 0x2e, 0x38, 0x1e, 0x22, 0x40, 0x22 // sp + 8 * VG + 16
...
; CHECK64-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x38, 0x1e, 0x22, 0x23, 0x90, 0x01 // sp + 8 * VG + 144
...
; CHECK1024-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x38, 0x1e, 0x22, 0x23, 0x90, 0x10 // sp + 8 * VG + 2064
; CHECK1024-NEXT:    .cfi_offset w29, -8
; CHECK1024-NEXT:    .cfi_offset b8, -1040
...
; CHECK0-NEXT:    .cfi_escape 0x0f, 0x08, 0x6f, 0x90, 0x2e, 0x38, 0x1e, 0x22, 0x40, 0x22 // sp + 8 * VG + 16
; CHECK0-NEXT:    .cfi_offset w29, -16
; CHECK0-NEXT:    .cfi_escape 0x10, 0x48, 0x08, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x40, 0x1c // $d8 @ cfa - 8 * VG - 16
; CHECK0-NEXT:    //APP
; CHECK0-NEXT:    //NO_APP
; CHECK0-NEXT:    mov w0, wzr
...
; CHECK64-NEXT:    .cfi_escape 0x10, 0x48, 0x0a, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x11, 0xb0, 0x7f, 0x22 // $d8 @ cfa - 8 * VG - 80
; CHECK64-NEXT:    mov w0, wzr
; CHECK64-NEXT:    //APP
; CHECK64-NEXT:    //NO_APP
; CHECK64-NEXT:    add sp, sp, #64
...
; CHECK1024-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x38, 0x1e, 0x22, 0x23, 0x90, 0x10 // sp + 8 * VG + 2064
; CHECK1024-NEXT:    .cfi_offset w29, -16
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x48, 0x0a, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x11, 0xf0, 0x77, 0x22 // $d8 @ cfa - 8 * VG - 1040
; CHECK1024-NEXT:    mov w0, wzr
; CHECK1024-NEXT:    //APP
; CHECK1024-NEXT:    //NO_APP
; CHECK1024-NEXT:    add sp, sp, #1024
...
; CHECK0-NEXT:    .cfi_escape 0x0f, 0x08, 0x6f, 0x90, 0x2e, 0x40, 0x1e, 0x22, 0x40, 0x22 // sp + 16 * VG + 16
; CHECK0-NEXT:    .cfi_offset w29, -16
; CHECK0-NEXT:    .cfi_escape 0x10, 0x48, 0x08, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x40, 0x1c // $d8 @ cfa - 8 * VG - 16
; CHECK0-NEXT:    .cfi_escape 0x10, 0x49, 0x08, 0x90, 0x2e, 0x11, 0x70, 0x1e, 0x22, 0x40, 0x1c // $d9 @ cfa - 16 * VG - 16
; CHECK0-NEXT:    //APP
; CHECK0-NEXT:    //NO_APP
; CHECK0-NEXT:    mov w0, wzr
...
; CHECK64-NEXT:    sub sp, sp, #64
; CHECK64-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x40, 0x1e, 0x22, 0x23, 0x90, 0x01 // sp + 16 * VG + 144
; CHECK64-NEXT:    .cfi_offset w29, -16
; CHECK64-NEXT:    .cfi_escape 0x10, 0x48, 0x0a, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x11, 0xb0, 0x7f, 0x22 // $d8 @ cfa - 8 * VG - 80
; CHECK64-NEXT:    .cfi_escape 0x10, 0x49, 0x0a, 0x90, 0x2e, 0x11, 0x70, 0x1e, 0x22, 0x11, 0xb0, 0x7f, 0x22 // $d9 @ cfa - 16 * VG - 80
; CHECK64-NEXT:    mov w0, wzr
; CHECK64-NEXT:    //APP
; CHECK64-NEXT:    //NO_APP
; CHECK64-NEXT:    add sp, sp, #64
...
; CHECK1024-NEXT:    sub sp, sp, #1024
; CHECK1024-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x40, 0x1e, 0x22, 0x23, 0x90, 0x10 // sp + 16 * VG + 2064
; CHECK1024-NEXT:    .cfi_offset w29, -16
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x48, 0x0a, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x11, 0xf0, 0x77, 0x22 // $d8 @ cfa - 8 * VG - 1040
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x49, 0x0a, 0x90, 0x2e, 0x11, 0x70, 0x1e, 0x22, 0x11, 0xf0, 0x77, 0x22 // $d9 @ cfa - 16 * VG - 1040
; CHECK1024-NEXT:    mov w0, wzr
; CHECK1024-NEXT:    //APP
; CHECK1024-NEXT:    //NO_APP
; CHECK1024-NEXT:    add sp, sp, #1024
...
; CHECK64-NEXT:    str z8, [sp] // 16-byte Folded Spill
; CHECK64-NEXT:    sub sp, sp, #80
; CHECK64-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x38, 0x1e, 0x22, 0x23, 0xa0, 0x01 // sp + 8 * VG + 160
; CHECK64-NEXT:    .cfi_offset w29, -16
; CHECK64-NEXT:    .cfi_escape 0x10, 0x48, 0x0a, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x11, 0xb0, 0x7f, 0x22 // $d8 @ cfa - 8 * VG - 80
; CHECK64-NEXT:    mov w0, wzr
; CHECK64-NEXT:    //APP
...
; CHECK1024-NEXT:    str z8, [sp] // 16-byte Folded Spill
; CHECK1024-NEXT:    sub sp, sp, #1040
; CHECK1024-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x38, 0x1e, 0x22, 0x23, 0xa0, 0x10 // sp + 8 * VG + 2080
; CHECK1024-NEXT:    .cfi_offset w29, -16
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x48, 0x0a, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x11, 0xf0, 0x77, 0x22 // $d8 @ cfa - 8 * VG - 1040
; CHECK1024-NEXT:    mov w0, wzr
; CHECK1024-NEXT:    //APP
...
; CHECK0-NEXT:    sub sp, sp, #16
; CHECK0-NEXT:    .cfi_escape 0x0f, 0x09, 0x6f, 0x90, 0x2e, 0x10, 0x40, 0x1e, 0x22, 0x23, 0x50 // sp + 64 * VG + 80
; CHECK0-NEXT:    .cfi_offset w19, -8
; CHECK0-NEXT:    .cfi_offset w20, -16
; CHECK0-NEXT:    .cfi_offset w21, -24
; CHECK0-NEXT:    .cfi_offset w22, -32
...
; CHECK0-NEXT:    .cfi_escape 0x10, 0x48, 0x09, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x11, 0x40, 0x22 // $d8 @ cfa - 8 * VG - 64
; CHECK0-NEXT:    .cfi_escape 0x10, 0x49, 0x09, 0x90, 0x2e, 0x11, 0x70, 0x1e, 0x22, 0x11, 0x40, 0x22 // $d9 @ cfa - 16 * VG - 64
; CHECK0-NEXT:    .cfi_escape 0x10, 0x4a, 0x09, 0x90, 0x2e, 0x11, 0x68, 0x1e, 0x22, 0x11, 0x40, 0x22 // $d10 @ cfa - 24 * VG - 64
; CHECK0-NEXT:    .cfi_escape 0x10, 0x4b, 0x09, 0x90, 0x2e, 0x11, 0x60, 0x1e, 0x22, 0x11, 0x40, 0x22 // $d11 @ cfa - 32 * VG - 64
; CHECK0-NEXT:    .cfi_escape 0x10, 0x4c, 0x09, 0x90, 0x2e, 0x11, 0x58, 0x1e, 0x22, 0x11, 0x40, 0x22 // $d12 @ cfa - 40 * VG - 64
; CHECK0-NEXT:    .cfi_escape 0x10, 0x4d, 0x09, 0x90, 0x2e, 0x11, 0x50, 0x1e, 0x22, 0x11, 0x40, 0x22 // $d13 @ cfa - 48 * VG - 64
; CHECK0-NEXT:    .cfi_escape 0x10, 0x4e, 0x09, 0x90, 0x2e, 0x11, 0x48, 0x1e, 0x22, 0x11, 0x40, 0x22 // $d14 @ cfa - 56 * VG - 64
; CHECK0-NEXT:    .cfi_escape 0x10, 0x4f, 0x09, 0x90, 0x2e, 0x11, 0x40, 0x1e, 0x22, 0x11, 0x40, 0x22 // $d15 @ cfa - 64 * VG - 64
; CHECK0-NEXT:    mov x8, x0
; CHECK0-NEXT:    mov w0, wzr
; CHECK0-NEXT:    //APP
; CHECK0-NEXT:    //NO_APP
...
; CHECK64-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x40, 0x1e, 0x22, 0x23, 0xe0, 0x01 // sp + 64 * VG + 224
; CHECK64-NEXT:    .cfi_offset w19, -8
; CHECK64-NEXT:    .cfi_offset w20, -16
; CHECK64-NEXT:    .cfi_offset w21, -24
; CHECK64-NEXT:    .cfi_offset w22, -32
...
; CHECK64-NEXT:    .cfi_offset w25, -56
; CHECK64-NEXT:    .cfi_offset w29, -64
; CHECK64-NEXT:    .cfi_escape 0x10, 0x48, 0x0a, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x11, 0x80, 0x7f, 0x22 // $d8 @ cfa - 8 * VG - 128
; CHECK64-NEXT:    .cfi_escape 0x10, 0x49, 0x0a, 0x90, 0x2e, 0x11, 0x70, 0x1e, 0x22, 0x11, 0x80, 0x7f, 0x22 // $d9 @ cfa - 16 * VG - 128
; CHECK64-NEXT:    .cfi_escape 0x10, 0x4a, 0x0a, 0x90, 0x2e, 0x11, 0x68, 0x1e, 0x22, 0x11, 0x80, 0x7f, 0x22 // $d10 @ cfa - 24 * VG - 128
; CHECK64-NEXT:    .cfi_escape 0x10, 0x4b, 0x0a, 0x90, 0x2e, 0x11, 0x60, 0x1e, 0x22, 0x11, 0x80, 0x7f, 0x22 // $d11 @ cfa - 32 * VG - 128
; CHECK64-NEXT:    .cfi_escape 0x10, 0x4c, 0x0a, 0x90, 0x2e, 0x11, 0x58, 0x1e, 0x22, 0x11, 0x80, 0x7f, 0x22 // $d12 @ cfa - 40 * VG - 128
; CHECK64-NEXT:    .cfi_escape 0x10, 0x4d, 0x0a, 0x90, 0x2e, 0x11, 0x50, 0x1e, 0x22, 0x11, 0x80, 0x7f, 0x22 // $d13 @ cfa - 48 * VG - 128
; CHECK64-NEXT:    .cfi_escape 0x10, 0x4e, 0x0a, 0x90, 0x2e, 0x11, 0x48, 0x1e, 0x22, 0x11, 0x80, 0x7f, 0x22 // $d14 @ cfa - 56 * VG - 128
; CHECK64-NEXT:    .cfi_escape 0x10, 0x4f, 0x0a, 0x90, 0x2e, 0x11, 0x40, 0x1e, 0x22, 0x11, 0x80, 0x7f, 0x22 // $d15 @ cfa - 64 * VG - 128
; CHECK64-NEXT:    mov x8, x0
; CHECK64-NEXT:    mov w0, wzr
; CHECK64-NEXT:    //APP
; CHECK64-NEXT:    //NO_APP
...
; CHECK1024-NEXT:    sub sp, sp, #1056
; CHECK1024-NEXT:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x40, 0x1e, 0x22, 0x23, 0xe0, 0x10 // sp + 64 * VG + 2144
; CHECK1024-NEXT:    .cfi_offset w19, -8
; CHECK1024-NEXT:    .cfi_offset w20, -16
; CHECK1024-NEXT:    .cfi_offset w21, -24
; CHECK1024-NEXT:    .cfi_offset w22, -32
...
; CHECK1024-NEXT:    .cfi_offset w25, -56
; CHECK1024-NEXT:    .cfi_offset w29, -64
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x48, 0x0a, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x11, 0xc0, 0x77, 0x22 // $d8 @ cfa - 8 * VG - 1088
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x49, 0x0a, 0x90, 0x2e, 0x11, 0x70, 0x1e, 0x22, 0x11, 0xc0, 0x77, 0x22 // $d9 @ cfa - 16 * VG - 1088
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x4a, 0x0a, 0x90, 0x2e, 0x11, 0x68, 0x1e, 0x22, 0x11, 0xc0, 0x77, 0x22 // $d10 @ cfa - 24 * VG - 1088
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x4b, 0x0a, 0x90, 0x2e, 0x11, 0x60, 0x1e, 0x22, 0x11, 0xc0, 0x77, 0x22 // $d11 @ cfa - 32 * VG - 1088
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x4c, 0x0a, 0x90, 0x2e, 0x11, 0x58, 0x1e, 0x22, 0x11, 0xc0, 0x77, 0x22 // $d12 @ cfa - 40 * VG - 1088
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x4d, 0x0a, 0x90, 0x2e, 0x11, 0x50, 0x1e, 0x22, 0x11, 0xc0, 0x77, 0x22 // $d13 @ cfa - 48 * VG - 1088
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x4e, 0x0a, 0x90, 0x2e, 0x11, 0x48, 0x1e, 0x22, 0x11, 0xc0, 0x77, 0x22 // $d14 @ cfa - 56 * VG - 1088
; CHECK1024-NEXT:    .cfi_escape 0x10, 0x4f, 0x0a, 0x90, 0x2e, 0x11, 0x40, 0x1e, 0x22, 0x11, 0xc0, 0x77, 0x22 // $d15 @ cfa - 64 * VG - 1088
; CHECK1024-NEXT:    mov x8, x0
; CHECK1024-NEXT:    mov w0, wzr
; CHECK1024-NEXT:    //APP
; CHECK1024-NEXT:    //NO_APP
