...
; CHECK:    str z9, [sp, #16, mul vl] // 16-byte Folded Spill
; CHECK:    str z8, [sp, #17, mul vl] // 16-byte Folded Spill
; CHECK:    .cfi_escape 0x0f, 0x0a, 0x6f, 0x90, 0x2e, 0x10, 0x90, 0x01, 0x1e, 0x22, 0x40, 0x22 // sp + 144 * VG + 16
; CHECK:    .cfi_escape 0x10, 0x48, 0x08, 0x90, 0x2e, 0x11, 0x78, 0x1e, 0x22, 0x40, 0x1c // $d8 @ cfa - 8 * VG - 16
; CHECK:    .cfi_escape 0x10, 0x49, 0x08, 0x90, 0x2e, 0x11, 0x70, 0x1e, 0x22, 0x40, 0x1c // $d9 @ cfa - 16 * VG - 16
; CHECK:    .cfi_escape 0x10, 0x4a, 0x08, 0x90, 0x2e, 0x11, 0x68, 0x1e, 0x22, 0x40, 0x1c // $d10 @ cfa - 24 * VG - 16
; CHECK:    .cfi_escape 0x10, 0x4b, 0x08, 0x90, 0x2e, 0x11, 0x60, 0x1e, 0x22, 0x40, 0x1c // $d11 @ cfa - 32 * VG - 16
; CHECK:    .cfi_escape 0x10, 0x4c, 0x08, 0x90, 0x2e, 0x11, 0x58, 0x1e, 0x22, 0x40, 0x1c // $d12 @ cfa - 40 * VG - 16
; CHECK:    .cfi_escape 0x10, 0x4d, 0x08, 0x90, 0x2e, 0x11, 0x50, 0x1e, 0x22, 0x40, 0x1c // $d13 @ cfa - 48 * VG - 16
; CHECK:    .cfi_escape 0x10, 0x4e, 0x08, 0x90, 0x2e, 0x11, 0x48, 0x1e, 0x22, 0x40, 0x1c // $d14 @ cfa - 56 * VG - 16
; CHECK:    .cfi_escape 0x10, 0x4f, 0x08, 0x90, 0x2e, 0x11, 0x40, 0x1e, 0x22, 0x40, 0x1c // $d15 @ cfa - 64 * VG - 16
; CHECK:    bl normal_callee
;
; UNWINDINFO:      DW_CFA_def_cfa_expression: DW_OP_reg31, DW_OP_regx 0x2e, DW_OP_constu 0x90, DW_OP_mul, DW_OP_plus, DW_OP_lit16, DW_OP_plus
; UNWINDINFO:      DW_CFA_expression: reg72 DW_OP_regx 0x2e, DW_OP_consts -8, DW_OP_mul, DW_OP_plus, DW_OP_lit16, DW_OP_minus
; UNWINDINFO-NEXT: DW_CFA_expression: reg73 DW_OP_regx 0x2e, DW_OP_consts -16, DW_OP_mul, DW_OP_plus, DW_OP_lit16, DW_OP_minus
; UNWINDINFO-NEXT: DW_CFA_expression: reg74 DW_OP_regx 0x2e, DW_OP_consts -24, DW_OP_mul, DW_OP_plus, DW_OP_lit16, DW_OP_minus
; UNWINDINFO-NEXT: DW_CFA_expression: reg75 DW_OP_regx 0x2e, DW_OP_consts -32, DW_OP_mul, DW_OP_plus, DW_OP_lit16, DW_OP_minus
; UNWINDINFO-NEXT: DW_CFA_expression: reg76 DW_OP_regx 0x2e, DW_OP_consts -40, DW_OP_mul, DW_OP_plus, DW_OP_lit16, DW_OP_minus
; UNWINDINFO-NEXT: DW_CFA_expression: reg77 DW_OP_regx 0x2e, DW_OP_consts -48, DW_OP_mul, DW_OP_plus, DW_OP_lit16, DW_OP_minus
; UNWINDINFO-NEXT: DW_CFA_expression: reg78 DW_OP_regx 0x2e, DW_OP_consts -56, DW_OP_mul, DW_OP_plus, DW_OP_lit16, DW_OP_minus
; UNWINDINFO-NEXT: DW_CFA_expression: reg79 DW_OP_regx 0x2e, DW_OP_consts -64, DW_OP_mul, DW_OP_plus, DW_OP_lit16, DW_OP_minus
  call void @normal_callee()
  ret void
}
