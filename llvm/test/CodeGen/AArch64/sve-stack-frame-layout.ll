...
; CHECK-FRAMELAYOUT-NEXT: Offset: [SP-128], Type: Variable, Align: 8, Size: 16
; CHECK-FRAMELAYOUT-NEXT: Offset: [SP-128], Type: VariableSized, Align: 1, Size: 0
...
; CHECK-NEXT:  .LBB8_2: // %after.restore.za
