...
define <vscale x 20 x i8> @deinterleave5_trunc_interleave5(<vscale x 20 x i16> %v) {
; CHECK-LABEL: define <vscale x 20 x i8> @deinterleave5_trunc_interleave5(
; CHECK-SAME: <vscale x 20 x i16> [[V:%.*]]) {
; CHECK-NEXT:    [[R:%.*]] = trunc <vscale x 20 x i16> [[V]] to <vscale x 20 x i8>
; CHECK-NEXT:    ret <vscale x 20 x i8> [[R]]
;
  %d = call { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } @llvm.vector.deinterleave5.nxv20i16(<vscale x 20 x i16> %v)
  %f0 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 0
  %f1 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 1
  %f2 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 2
  %f3 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 3
  %f4 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 4
  %t0 = trunc <vscale x 4 x i16> %f0 to <vscale x 4 x i8>
  %t1 = trunc <vscale x 4 x i16> %f1 to <vscale x 4 x i8>
  %t2 = trunc <vscale x 4 x i16> %f2 to <vscale x 4 x i8>
  %t3 = trunc <vscale x 4 x i16> %f3 to <vscale x 4 x i8>
  %t4 = trunc <vscale x 4 x i16> %f4 to <vscale x 4 x i8>
  %r = call <vscale x 20 x i8> @llvm.vector.interleave5.nxv20i8(<vscale x 4 x i8> %t0, <vscale x 4 x i8> %t1, <vscale x 4 x i8> %t2, <vscale x 4 x i8> %t3, <vscale x 4 x i8> %t4)
  ret <vscale x 20 x i8> %r
}

define <vscale x 24 x i16> @deinterleave6_interleave6_direct(<vscale x 24 x i16> %v) {
; CHECK-LABEL: define <vscale x 24 x i16> @deinterleave6_interleave6_direct(
; CHECK-SAME: <vscale x 24 x i16> [[V:%.*]]) {
; CHECK-NEXT:    ret <vscale x 24 x i16> [[V]]
;
  %d = call { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } @llvm.vector.deinterleave6.nxv24i16(<vscale x 24 x i16> %v)
  %f0 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 0
  %f1 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 1
  %f2 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 2
  %f3 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 3
  %f4 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 4
  %f5 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 5
  %r = call <vscale x 24 x i16> @llvm.vector.interleave6.nxv24i16(<vscale x 4 x i16> %f0, <vscale x 4 x i16> %f1, <vscale x 4 x i16> %f2, <vscale x 4 x i16> %f3, <vscale x 4 x i16> %f4, <vscale x 4 x i16> %f5)
  ret <vscale x 24 x i16> %r
}
...
; Future-support candidate: the pair fold currently only handles truncation casts.
define <vscale x 16 x i16> @future_deinterleave4_zext_interleave4(<vscale x 16 x i8> %v) {
; CHECK-LABEL: define <vscale x 16 x i16> @future_deinterleave4_zext_interleave4(
; CHECK-SAME: <vscale x 16 x i8> [[V:%.*]]) {
; CHECK-NEXT:    [[D:%.*]] = call { <vscale x 4 x i8>, <vscale x 4 x i8>, <vscale x 4 x i8>, <vscale x 4 x i8> } @llvm.vector.deinterleave4.nxv16i8(<vscale x 16 x i8> [[V]])
; CHECK-NEXT:    [[F0:%.*]] = extractvalue { <vscale x 4 x i8>, <vscale x 4 x i8>, <vscale x 4 x i8>, <vscale x 4 x i8> } [[D]], 0
; CHECK-NEXT:    [[F1:%.*]] = extractvalue { <vscale x 4 x i8>, <vscale x 4 x i8>, <vscale x 4 x i8>, <vscale x 4 x i8> } [[D]], 1
; CHECK-NEXT:    [[F2:%.*]] = extractvalue { <vscale x 4 x i8>, <vscale x 4 x i8>, <vscale x 4 x i8>, <vscale x 4 x i8> } [[D]], 2
; CHECK-NEXT:    [[F3:%.*]] = extractvalue { <vscale x 4 x i8>, <vscale x 4 x i8>, <vscale x 4 x i8>, <vscale x 4 x i8> } [[D]], 3
; CHECK-NEXT:    [[U0:%.*]] = zext <vscale x 4 x i8> [[F0]] to <vscale x 4 x i16>
; CHECK-NEXT:    [[U1:%.*]] = zext <vscale x 4 x i8> [[F1]] to <vscale x 4 x i16>
; CHECK-NEXT:    [[U2:%.*]] = zext <vscale x 4 x i8> [[F2]] to <vscale x 4 x i16>
; CHECK-NEXT:    [[U3:%.*]] = zext <vscale x 4 x i8> [[F3]] to <vscale x 4 x i16>
...
; Future-support candidate: the pair fold currently bails out on fixed-width vectors.
define <16 x i8> @future_fixed_deinterleave4_lshr_trunc_interleave4(<16 x i16> %v) {
; CHECK-LABEL: define <16 x i8> @future_fixed_deinterleave4_lshr_trunc_interleave4(
; CHECK-SAME: <16 x i16> [[V:%.*]]) {
; CHECK-NEXT:    [[D:%.*]] = call { <4 x i16>, <4 x i16>, <4 x i16>, <4 x i16> } @llvm.vector.deinterleave4.v16i16(<16 x i16> [[V]])
; CHECK-NEXT:    [[F0:%.*]] = extractvalue { <4 x i16>, <4 x i16>, <4 x i16>, <4 x i16> } [[D]], 0
; CHECK-NEXT:    [[F1:%.*]] = extractvalue { <4 x i16>, <4 x i16>, <4 x i16>, <4 x i16> } [[D]], 1
; CHECK-NEXT:    [[F2:%.*]] = extractvalue { <4 x i16>, <4 x i16>, <4 x i16>, <4 x i16> } [[D]], 2
; CHECK-NEXT:    [[F3:%.*]] = extractvalue { <4 x i16>, <4 x i16>, <4 x i16>, <4 x i16> } [[D]], 3
; CHECK-NEXT:    [[S0:%.*]] = lshr <4 x i16> [[F0]], splat (i16 8)
; CHECK-NEXT:    [[T0:%.*]] = trunc <4 x i16> [[S0]] to <4 x i8>
; CHECK-NEXT:    [[S1:%.*]] = lshr <4 x i16> [[F1]], splat (i16 8)
; CHECK-NEXT:    [[T1:%.*]] = trunc <4 x i16> [[S1]] to <4 x i8>
; CHECK-NEXT:    [[S2:%.*]] = lshr <4 x i16> [[F2]], splat (i16 8)
; CHECK-NEXT:    [[T2:%.*]] = trunc <4 x i16> [[S2]] to <4 x i8>
; CHECK-NEXT:    [[S3:%.*]] = lshr <4 x i16> [[F3]], splat (i16 8)
; CHECK-NEXT:    [[T3:%.*]] = trunc <4 x i16> [[S3]] to <4 x i8>
; CHECK-NEXT:    [[R:%.*]] = call <16 x i8> @llvm.vector.interleave4.v16i8(<4 x i8> [[T0]], <4 x i8> [[T1]], <4 x i8> [[T2]], <4 x i8> [[T3]])
...
; CHECK-NEXT:    [[F1:%.*]] = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } [[D]], 1
; CHECK-NEXT:    [[F2:%.*]] = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } [[D]], 2
; CHECK-NEXT:    [[R:%.*]] = call <vscale x 16 x i16> @llvm.vector.interleave4.nxv16i16(<vscale x 4 x i16> [[F0]], <vscale x 4 x i16> [[F1]], <vscale x 4 x i16> [[F2]], <vscale x 4 x i16> [[F0]])
; CHECK-NEXT:    ret <vscale x 16 x i16> [[R]]
;
  %d = call { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } @llvm.vector.deinterleave4.nxv16i16(<vscale x 16 x i16> %v)
  %f0 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 0
  %f1 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 1
  %f2 = extractvalue { <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16>, <vscale x 4 x i16> } %d, 2
  %r = call <vscale x 16 x i16> @llvm.vector.interleave4.nxv16i16(<vscale x 4 x i16> %f0, <vscale x 4 x i16> %f1, <vscale x 4 x i16> %f2, <vscale x 4 x i16> %f0)
  ret <vscale x 16 x i16> %r
}
