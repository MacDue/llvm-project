...
; CHECK-NEXT:    [[TMP4:%.*]] = shl nuw nsw i32 [[TMP3]], 2
; CHECK-NEXT:    [[TMP5:%.*]] = add nsw i32 [[TMP4]], -1
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <vscale x 4 x i1> [[ALIAS_LANE_MASK]], i32 [[TMP5]]
; CHECK-NEXT:    br i1 [[TMP6]], label [[VECTOR_PH:%.*]], label [[SCALAR_PH]]
; CHECK:       vector.ph:
