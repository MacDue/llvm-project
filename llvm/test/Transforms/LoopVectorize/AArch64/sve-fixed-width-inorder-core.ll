...
; CHECK-CA510-NEXT:    [[TMP20:%.*]] = extractelement <4 x i1> [[TMP19]], i32 3
; CHECK-CA510-NEXT:    [[TMP21:%.*]] = icmp eq i1 [[TMP20]], false
; CHECK-CA510-NEXT:    br i1 [[TMP21]], label %[[SCALAR_PH]], label %[[VECTOR_PH:.*]]
...
; CHECK-CA520-NEXT:    [[TMP20:%.*]] = extractelement <4 x i1> [[TMP19]], i32 3
; CHECK-CA520-NEXT:    [[TMP21:%.*]] = icmp eq i1 [[TMP20]], false
; CHECK-CA520-NEXT:    br i1 [[TMP21]], label %[[SCALAR_PH]], label %[[VECTOR_PH:.*]]
...
; CHECK-CA320-NEXT:    [[TMP18:%.*]] = extractelement <4 x i1> [[TMP17]], i32 3
; CHECK-CA320-NEXT:    [[TMP19:%.*]] = icmp eq i1 [[TMP18]], false
; CHECK-CA320-NEXT:    br i1 [[TMP19]], label %[[SCALAR_PH]], label %[[VECTOR_PH:.*]]
