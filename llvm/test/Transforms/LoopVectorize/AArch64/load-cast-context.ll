...
; CHECK-NEXT:    [[N_MOD_VF10:%.*]] = urem i64 [[TMP0]], 16
...
; CHECK-NEXT:    [[VEC_PHI13:%.*]] = phi <16 x i32> [ [[TMP32]], %[[VEC_EPILOG_PH]] ], [ [[TMP39:%.*]], %[[VEC_EPILOG_VECTOR_BODY]] ]
...
; CHECK-NEXT:    [[WIDE_LOAD14:%.*]] = load <16 x i8>, ptr [[TMP38]], align 1
; CHECK-NEXT:    [[TMP40:%.*]] = zext <16 x i8> [[WIDE_LOAD14]] to <16 x i32>
; CHECK-NEXT:    [[TMP39]] = or <16 x i32> [[VEC_PHI13]], [[TMP40]]
; CHECK-NEXT:    [[INDEX_NEXT15]] = add nuw i64 [[INDEX12]], 16
...
; CHECK-NEXT:    [[TMP42:%.*]] = call i32 @llvm.vector.reduce.or.v16i32(<16 x i32> [[TMP39]])
...
; CHECK: [[PROF4]] = !{!"branch_weights", i32 16, i32 48}
