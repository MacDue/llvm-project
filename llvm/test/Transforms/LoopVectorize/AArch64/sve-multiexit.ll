...
; CHECK-NEXT:    [[TMP18:%.*]] = mul nuw i32 [[TMP7]], 4
; CHECK-NEXT:    [[TMP8:%.*]] = mul nuw i32 [[TMP18]], 2
...
; CHECK-NEXT:    [[TMP24:%.*]] = getelementptr inbounds i32, ptr [[TMP19]], i64 [[TMP20]]
...
; CHECK-NEXT:    [[TMP25:%.*]] = getelementptr inbounds i32, ptr [[A]], i32 [[INDEX]]
